...
const config: Config = {
  ...
  presets: [
    [
      'classic',
      {
        ...
        blog: false,
        // uncomment when we want to start blogging
        // blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'Clear Signing Alliance',
      // logo: {
      //   alt: 'Clear Signing Alliance Logo',
      //   src: 'img/logo.svg',
      // },
      items: [
        {
        ...
        {
          href: 'https://github.com/clear-signing/',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      //       {
      //         label: 'X',
      //         href: 'https://x.com/clear-signing',
      //       },
      //     ],
      //   },
      //   {
      ...
      //   },
      // ],
      copyright: `Copyright © ${new Date().getFullYear()} Clear Signing Alliance`,
    },
    prism: {
